    ...
    <div class="wrapper">
        ...
        <header class="main-header">
                ...
                <div class="container">
                    <div class="navbar-header">
                        <a href="{{ url(config('adminlte.dashboard_url', 'home')) }}" class="navbar-brand">
                            {!! config('adminlte.logo', 'AdminController') !!}
                        </a>
            ...
            <a href="{{ url(config('adminlte.dashboard_url', 'home')) }}" class="logo">
                ...
                <span class="logo-lg">{!! config('adminlte.logo', 'AdminController') !!}</span>
            </a>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a id="systemsettingBtn" href="{{url('admin/reset')}}" class="btn btn-default btn-flat">修改密码</a>
                                    </div>
                                    <div class="pull-right">
                                        <a href="{{url('admin/logout')}}" class="btn btn-default btn-flat">注销</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="#" data-toggle="control-sidebar-toggle-button">
